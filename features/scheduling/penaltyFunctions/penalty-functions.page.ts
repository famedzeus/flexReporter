...
const COMPONENT_SELECTOR = 'penalty-functions'
export class PenaltyFunctionsComponent extends GenericEntityCrud {
  ...
  async navigate() {
    await browser.get(`#/scheduling/schedules/${scheduleScope.scheduleScopeName}/penaltyFunctions`)
